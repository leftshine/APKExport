...
import com.echooit.apkexport.adapter.ContentPagerAdapter;
import com.echooit.apkexport.fragment.UserAppFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                anim.start();
                //((UserAppFragment)fragmentManager.findFragmentById(R.id.layout_fragment)).refresh();
...
/*        for (String s : tabIndicators) {
            tabFragments.add(UserAppFragment.newInstance(s));
        }*/
        if(fragmentUserApp==null) {
            fragmentUserApp = UserAppFragment.newInstance(ToolUtils.TYPE_USER);
            tabFragments.add(fragmentUserApp);
        }
        if(fragmentSystemApp==null) {
            fragmentSystemApp = UserAppFragment.newInstance(ToolUtils.TYPE_SYSTEM);
            tabFragments.add(fragmentSystemApp);
        }
        fragmentUserApp.refresh();
        ...
        mContentVp.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                UserAppFragment fragment = (UserAppFragment)contentAdapter.getItem(position);
                fragment.refresh();
